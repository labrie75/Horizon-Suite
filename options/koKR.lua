...
L["Beta"]                                               = "Beta"
L["Scaling"]                                            = "크기 조절"
L["Global UI scale"]                                    = "전체 UI 배율"
L["Scale all sizes, spacings, and fonts by this factor (50–200%). Does not change your configured values."] = "모든 크기, 간격, 글꼴을 이 비율로 조절합니다 (50–200%). 설정값은 변경되지 않습니다."
L["Per-module scaling"]                                 = "모듈별 배율"
L["Override the global scale with individual sliders for each module."] = "전체 배율을 무시하고 각 모듈별로 개별 슬라이더를 사용합니다."
L["Focus scale"]                                        = "Focus 배율"
L["Scale for the Focus objective tracker (50–200%)."]   = "Focus 목표 추적기의 배율 (50–200%)."
L["Presence scale"]                                     = "Presence 배율"
L["Scale for the Presence cinematic text (50–200%)."]   = "Presence 시네마틱 텍스트의 배율 (50–200%)."
L["Vista scale"]                                        = "Vista 배율"
L["Scale for the Vista minimap module (50–200%)."]      = "Vista 미니맵 모듈의 배율 (50–200%)."
L["Insight scale"]                                      = "Insight 배율"
L["Scale for the Insight tooltip module (50–200%)."]    = "Insight 툴팁 모듈의 배율 (50–200%)."
L["Yield scale"]                                        = "Yield 배율"
L["Scale for the Yield loot toast module (50–200%)."]   = "Yield 전리품 토스트 모듈의 배율 (50–200%)."
...
L["Show world quest accept"]                            = "월드 퀘스트 수락 표시"
L["Show notification when accepting a world quest."]    = "월드 퀘스트를 수락할 때 알림을 표시합니다."
L["Show quest complete"]                                = "퀘스트 완료 표시"
L["Show notification when completing a quest."]         = "퀘스트를 완료할 때 알림을 표시합니다."
L["Show world quest complete"]                          = "월드 퀘스트 완료 표시"
L["Show notification when completing a world quest."]   = "월드 퀘스트를 완료할 때 알림을 표시합니다."
...
L["Show notification when entering a scenario or Delve."] = "시나리오나 델브에 입장할 때 알림을 표시합니다."
L["Show scenario progress"]                             = "시나리오 진행 표시"
L["Show notification when scenario or Delve objectives update."] = "시나리오나 델브 목표가 갱신될 때 알림을 표시합니다."
L["Animation"]                                          = "애니메이션"
