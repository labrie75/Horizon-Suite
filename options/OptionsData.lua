...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = "Show category headers when collapsed", desc = "When the panel is collapsed, keep section headers (Campaign, World Quests, etc.) visible. Click a header to expand that category.", dbKey = "showSectionHeadersWhenCollapsed", get = function() return getDB("showSectionHeadersWhenCollapsed", false) end, set = function(v) setDB("showSectionHeadersWhenCollapsed", v) end },
            { type = "toggle", name = "Show Nearby (Current Zone) group", desc = "Show accepted quests in your current zone in a dedicated CURRENT ZONE section. When off, they appear in their normal category (e.g. Dailies, Campaign, Quests).", dbKey = "showNearbyGroup", get = function() return getDB("showNearbyGroup", true) end, set = function(v) setDB("showNearbyGroup", v) end },
