...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "color", name = "Header color", desc = "Color of the OBJECTIVES header text.", dbKey = "headerColor", default = addon.HEADER_COLOR },
            { type = "slider", name = "Header height", desc = "Height of the header bar in pixels (18–48).", dbKey = "headerHeight", min = 18, max = 48, get = function() return math.max(18, math.min(48, tonumber(getDB("headerHeight", addon.HEADER_HEIGHT)) or addon.HEADER_HEIGHT)) end, set = function(v) setDB("headerHeight", math.max(18, math.min(48, v))) end },
