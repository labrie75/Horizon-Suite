...
local OptionCategories = {
    ...
    },
    {
        ...
        options = {
            ...
            { type = "toggle", name = "Show quest type icons", desc = "Show quest type icon next to each title in the tracker and on Presence notifications (quest accept/complete, world quest).", dbKey = "showQuestTypeIcons", get = function() return getDB("showQuestTypeIcons", false) end, set = function(v) setDB("showQuestTypeIcons", v) end },
